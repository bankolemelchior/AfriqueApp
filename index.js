...
const country = [
    ...
    ghana = new Pays("Ghana", 233, "GHS", "Cedi", "Afrique de l'ouest", "Accra", "flags/Ghana-v1.png"),

    guinée = new Pays("Guinée", 224, "GNF", "Franc guinéen", "Afrique de l'ouest", "Conakry", "flags/Guinee-v1.png"),

    guineeEquatoriale = new Pays("Guinée équatoriale", 240, "XAF", "Franc CFA (CEMAC)", "Afrique centrale", "Malabo", "flags/Guinee-Equatoriale-v1.png"),

    guineeBissau = new Pays("Guinée-Bissau", 245, "XOF", "Franc CFA (UEMOA)", "Afrique de l'ouest", "Bissau", "flags/Guinee-Bissau-v1.png"),

    kenya = new Pays("Kenya", 254, "KES", "Shilling kényan", "Afrique de l’est", "Nairobi", "flags/Kenya-v1.png"),
]
